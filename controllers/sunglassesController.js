...
const sunglassesController = {
  createProduct: async (req, res) => {
    try {
      ...
      const existingProduct = await Sunglasses.findOne({
        modelName,
        modelNo,
        collectionName,
        description,
  ...
  updateById: async (req, res) => {
    try {
      ...
      const product = await Sunglasses.findById(productId);
      if (!product) {
  ...
  deleteById: async (req, res) => {
    try {
      ...
      const deletedProduct = await Sunglasses.findByIdAndDelete(productId);
...
module.exports = sunglassesController;
